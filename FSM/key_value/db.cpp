...
fsm::FSMResponse kv::DB::query_state(const fsm::SerializedData &serialized_query) {
...
std::optional<fsm::RequestType> kv::DB::get_request_type(const fsm::SerializedData &serialized_request) {
